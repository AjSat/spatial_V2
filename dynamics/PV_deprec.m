function  [qdd, nu, tau_apply, a, Xa, v, q_acc_X_fun, tau_X_fun] = PV( model, q, qd, tau, f_ext, A_con, m_con, L_inv )
...
if size(A_con, 2) > 0
    q_acc_X_fun = jacobian([qdd;con_torque; nu], [m_con; tau; q]);
